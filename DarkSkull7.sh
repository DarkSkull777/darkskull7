...
echo $i  "AUTHOR     : DarkSkull7 (Dim)"

echo $i  "IG         : @dimassrmdani

echo $i  "TELEGRAM   : @xskull7

echo $i  "GITHUB     : https://github.com/DarkSkull777"

echo $cy "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

echo $i  "MY TEAM   : {BraveXPloiter}"
...
echo "->> DAFTAR TOOLS MILIK DarkSkull777 <<-"
...
echo $cy "[7]"$bi" Sadap Camera"

echo "=================================================="

echo $cy "[8]"$i" Dark Facebook V1,6"

echo "=================================================="

echo $cy "[9]"$me" DDOS ATTACK ,hammer"

echo "=================================================="

echo $cy "[10]"$ku" HACK CCTV ,ipcs"
...
echo $cy "[12] "$bi" Install Terminal Termux"
...
echo $cy"┌==="$bi"[> Masukan Pilihan Kmu <]"
...
git clone https://github.com/P3RT4M4/T3RM1N4L
...
echo $i"Dm IG :"$i" @dimassrmdani"

echo $bi"Tele :"$i" t.me/xskull7"
